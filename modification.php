...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($role == "student") {
        ...
        // Retrieve existing Registration_ID from the database based on the provided ID
        ...
        // Construct SQL query and parameter binding dynamically
        ...
        // Append the Registration_ID and its parameter type to the params and paramTypes arrays
        ...
        if ($stmt) {
            // Bind parameters dynamically based on the collected values
...
elseif ($role == "Professor") {
    ...
    // Retrieve existing ProfessorID from the database based on the provided ID
